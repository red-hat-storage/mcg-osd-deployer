...
const (
	ManagedMCFName = "test-managedmcg"
...
var _ = BeforeSuite(func(done Done) {
	...
	go RunServer(k8sClient, types.NamespacedName{Name: ManagedMCFName, Namespace: TestNamespace}, ctrl.Log.WithName("readiness"))
	...
	Expect(k8sClient.Create(ctx, managedMCG)).Should(Succeed())
...
var _ = AfterSuite(func() {
	...
	Expect(k8sClient.Delete(ctx, managedMCG)).Should(Succeed())
